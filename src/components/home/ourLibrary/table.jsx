...
import { deleteLibrary } from "../../../api/services/home";

const OurLibraryTable = ({
  data,
  setPage,
  limit,
  setLimit,
  ...
  const navigate = useNavigate();
    ...
    if (instance_ids) {
        deleteLibrary({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/home/create-our-library`, { state: { id: row.id } })}
          >
...
export default OurLibraryTable;
