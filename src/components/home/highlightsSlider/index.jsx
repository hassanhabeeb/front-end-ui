...
import HighlightsSliderTable from './table';
import { IoSearchOutline } from "react-icons/io5";
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getHighlightsSliderList } from '../../../api/services/home';
...
const HighlightsSlider = () => {
    ...
    useEffect(() =>{
        ...
        getHighlightsSliderList({ page: page, limit: limit, search: search })((response) => {
            setPending(false);
                          ...
                          <div className='main'>
                              ...
                              <div className='request_btn_wrapper'>
                                  ...
                                  <div className='add-new-btn'>
                                      <Button style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/home/create-highlights-slider")}>
