...
import { deleteImpact, impactStatusChange } from "../../../api/services/home";
import { Form } from "react-bootstrap";

const TheImpactTable = ({
  data,
  setPage,
  limit,
  setLimit,
  ...
  const handleConfirm = () => {
    ...
    if (type === 'status') {
      impactStatusChange({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/home/create-the-impact`, { state: { id: row.id } })}
          >
