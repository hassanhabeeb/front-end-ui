...
import { deleteWhatWeDo, whatWeDoStatusChange } from "../../../api/services/home";
...
const WhatWeDoTable = ({
  ...
  const handleConfirm = () => {
    ...
    if (type === 'status') {
      whatWeDoStatusChange({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/home/create-what-we-do`, { state: { id: row.id, data: row } })}
          >
