...
import WhatWeDoTable from './table';
import { IoSearchOutline } from "react-icons/io5";
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getWhatWeDoList } from '../../../api/services/home';

const WhatWeDo = () => {
    const navigate = useNavigate();    
    // const [search, setSearch] = useState(""); // Removed search state
    ...
    */
    ...
    },[update, page, limit]); // Removed search dependency
                              ...
                              {/* Search Removed */}
                                  ...
                                  <div className='add-new-btn'>
                                      <Button 
                                        ...
                                        onClick={() => navigate("/home/create-what-we-do")}
                                      >
