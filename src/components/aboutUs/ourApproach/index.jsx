...
import OurApproachTable from './table';
import Layout from '../../layout';
import toast from 'react-hot-toast';
import { deleteOurApproach, getOurApproachList, ourApproachStatusChange } from '../../../api/services/aboutUs';
...
const OurApproach = () => {
    ...
    const handleStatusChange = (id) => {
        ourApproachStatusChange({ id: id })((res) => {
                    ...
                    <Row>
                        <Col md={12}>
                            <div className='title-section mt-5'>
                                <h4 className='activities-heading'>Our Approach</h4>
                            </div>
                                    ...
                                    <div className='d-flex align-items-center justify-content-between'>   
                                        ...
                                        <div className='add-new-btn'>
                                            <Button 
                                                ...
                                                onClick={() => navigate("/about-us/create-our-approach")}
                                            >
