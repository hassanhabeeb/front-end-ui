...
const AimsToAchieveTable = ({ data, handleSerialNumber, handleStatusChange, handleDelete, page, setPage, limit, setLimit, totalRows, pending }) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/about-us/create-aims-to-achieve`, { state: { id: row.id } })}
          >
...
export default AimsToAchieveTable;
