...
import ImplementedByTable from './table';
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getImplementedByList } from '../../../api/services/ourImpact';
...
const ImplementedBy = () => {
    ...
    const getList = () => {
        ...
        getImplementedByList(props)((res) => {
                          ...
                          <div className='main'>
                              ...
                              <div className='request_btn_wrapper'>
                                  ...
                                  <div className='add-new-btn'>
                                      <Button style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/our-impact/create-implemented-by")}>
