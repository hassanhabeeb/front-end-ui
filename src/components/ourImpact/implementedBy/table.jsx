...
import { deleteImplementedBy } from "../../../api/services/ourImpact";
import { Form } from "react-bootstrap";

const ImplementedByTable = ({
  data,
  setPage,
  limit,
  setLimit,
  ...
  const handleDelete = () => {
    ...
    deleteImplementedBy({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/our-impact/create-implemented-by`, { state: { id: row.id } })}
          >
...
export default ImplementedByTable;
