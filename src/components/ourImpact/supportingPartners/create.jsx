...
import { createSupportingPartner, getSupportingPartnerDetail } from '../../../api/services/ourImpact';

const CreateSupportingPartners = () => {   
  ...
  useEffect(() => {
      if (id) {
        getSupportingPartnerDetail({ id: id })((res) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
        ...
        createSupportingPartner(payload)((res) => {
            setLoading(false);
            if (res?.status && (res?.status_code == 200 || res?.status_code == 201)) {
                toast.success(res.message);
                navigate("/our-impact/supporting-partners");
            } else {
                    ...
                    <Row>
                        <Col md={12}>
                            <div className='title-section mt-5 mb-4 d-flex align-items-center'>
                                <div className='back_btn_wrap' onClick={() => navigate("/our-impact/supporting-partners")}>
                                    <MdArrowBack size={24}/>
                                </div>
                                <div className='title-txt'>
                                    <h4>{id ? "Edit Supporting Partner" : "Create Supporting Partner"}</h4>
                                </div>
                            </div>                                                    
                        </Col>
                        <Col md={12}>
                                    ...
                                    <Row>                              
                                        ...
                                        <div className='col-lg-12 d-flex align-items-center justify-content-end btn-section mt-4'>
                                            <Button                                             
                                                ...
                                                onClick={() => navigate("/our-impact/supporting-partners")}
                                            >
                                                Cancel
                                            </Button>
...
export default CreateSupportingPartners
