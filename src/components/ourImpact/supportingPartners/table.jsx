...
import { deleteSupportingPartner } from "../../../api/services/ourImpact";
import { Form } from "react-bootstrap";

const SupportingPartnersTable = ({
  data,
  setPage,
  limit,
  setLimit,
  ...
  const handleDelete = () => {
    ...
    deleteSupportingPartner({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/our-impact/create-supporting-partners`, { state: { id: row.id } })}
          >
...
export default SupportingPartnersTable;
