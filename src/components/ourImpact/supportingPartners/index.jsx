...
import SupportingPartnersTable from './table';
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getSupportingPartnerList } from '../../../api/services/ourImpact';
...
const SupportingPartners = () => {
    ...
    const getList = () => {
        ...
        getSupportingPartnerList(props)((res) => {
                          ...
                          <div className='main'>
                              ...
                              <div className='request_btn_wrapper'>
                                  ...
                                  <div className='add-new-btn'>
                                      <Button style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/our-impact/create-supporting-partners")}>
