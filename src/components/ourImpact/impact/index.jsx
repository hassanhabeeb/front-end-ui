...
import OurImpactTable from './table';
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getOurImpactList } from '../../../api/services/ourImpact';
                          ...
                          <div className='main'>
                              <div className='d-flex align-items-center justify-content-between'>   
                                ...
                                <div className='add-new-btn'>
                                    <Button disabled={totalRows > 0} style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/our-impact/create-impact")}>
