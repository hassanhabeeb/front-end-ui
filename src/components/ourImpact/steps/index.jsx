...
import StepsTable from './table';
import { useNavigate } from 'react-router-dom';
import Layout from '../../layout';
import { getStepsList } from '../../../api/services/ourImpact';
                          ...
                          <div className='main'>
                              ...
                              <div className='request_btn_wrapper'>
                                  ...
                                  <div className='add-new-btn'>
                                      <Button disabled={totalRows > 0} style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/our-impact/create-steps")}>
