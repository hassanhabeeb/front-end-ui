...
import { createFundedBy, getFundedByDetail } from '../../../api/services/ourImpact';

const CreateFundedBy = () => {   
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
        ...
        createFundedBy(payload)((res) => {
            setLoading(false);
            if (res?.status && (res?.status_code == 200 || res?.status_code == 201)) {
                toast.success(res.message);
                navigate("/our-impact/funded-by");
            } else {
                    ...
                    <Row>
                        <Col md={12}>
                            <div className='title-section mt-5 mb-4 d-flex align-items-center'>
                                <div className='back_btn_wrap' onClick={() => navigate("/our-impact/funded-by")}>
                                    <MdArrowBack size={24}/>
                                </div>
                                <div className='title-txt'>
                                    <h4>{id ? "Edit Funded By" : "Create Funded By"}</h4>
                                </div>
                            </div>                                                    
                        </Col>
                        <Col md={12}>
                                    ...
                                    <Row>                              
                                        ...
                                        <div className='col-lg-12 d-flex align-items-center justify-content-end btn-section mt-4'>
                                            <Button                                             
                                                ...
                                                onClick={() => navigate("/our-impact/funded-by")}
                                            >
                                                Cancel
                                            </Button>
