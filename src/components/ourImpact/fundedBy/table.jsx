...
import { deleteFundedBy } from "../../../api/services/ourImpact";
...
const FundedByTable = ({
  ...
  const handleDelete = () => {
    ...
    deleteFundedBy({ id: instance_ids })((res) => {
      ...
      cell: (row) => (
        <div className="action-wrapper">
          <Tooltip
            title="Edit"
            disableInteractive
            onClick={() => navigate(`/our-impact/create-funded-by`, { state: { id: row.id } })}
          >
