...
import { getSeoList } from '../../api/services/seo';
...
const Seo = () => {
    ...
    useEffect(() =>{
        ...
        getSeoList({
            ...
            limit: limit,
            search: search,
            // status: statusFilter // API doesn't seem to support this yet based on service file, but can be added if needed
        })(response => {
            setPending(false);
                  ...
                  <Col md={12}>
                      ...
                      <div className='add-filter-section mt-4'>
                          <div className='main'>
                              ...
                              <div className='request_btn_wrapper d-flex'>
                                      {/* Search */}
                                  ...
                                  <div className='add-new-btn'>
                                      <Button style={{background: 'linear-gradient(92deg, #57d89e9f, #03693b)', border: "none", outline: "none"}} onClick={() => navigate("/create-seo")}>
                                          <IoAddCircleOutline size={20} title='Create new seo'/>
                                          Create
                                      </Button>
                                  </div>
                              </div>
